      ...
      card_spell_1 = [28000001,28000002,28000008,28000011,28000012,28000015,28000017,28000018]
      card_spell_2 = [28000000,28000003,28000005,28000006,28000007,28000009,28000013,28000014]
              
      //メガナイト
      var number_26000055 = 1000 //ここに比率を入力
    for(i=0;i<number_26000055;i++){
    card_main.push(26000055)
    }
    card_1 = parseInt(Math.floor(Math.random()*(24+number_26000055)))
    card_2 = randoms_2[0]
    card_3 = randoms_2[1]
    ...
    //document.write(deck_4.link("https://link.clashroyale.com/deck/en?deck="+card_main[card_1]+";"+card_sky[card_2]+";"+card_sky[card_3]+";"+card_tank[card_4]+";"+card_area[card_5]+";"+card_facility[card_6]+";"+card_spell_1[card_7]+";"+card_spell_2[card_8])  )
